  ...
  head: () => ({
    meta: [
      { title: "Teams & Riders — MCF National Cycling Event 2026" },
      {
        name: "description",
        content:
          "Registration status, confirmed teams and riders, document checklist, bib collection and team managers' meeting information for the 2026 MCF National Cycling Event.",
      },
      { property: "og:title", content: "Teams & Riders — MCF National Cycling Event 2026" },
      {
        property: "og:description",
        content:
          "Confirmed riders, teams and rider information for the 2026 MCF National Cycling Event.",
      },
    ],
  }),
  loader: ({ context }) => {
