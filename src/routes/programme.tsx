    ...
    items: [
      {
        ...
        type: "Meeting",
        notes: "15-minute window. Bib + transponder check; closes 15 min before each start.",
      },
      {
        time: "07:00–07:45",
        event: "Junior Criterium / လူငယ်တန်း Criterium",
        category: "15 laps × 1.3 km · 45-minute race block",
        venue: "Thuwunna outer ring",
        type: "Points",
        notes: "Race 1",
      },
      ...
      },
      {
        ...
        category: "5 laps × 1.3 km · 45-minute race block",
        venue: "Thuwunna outer ring",
        type: "Separate",
      ...
      {
        time: "10:50–11:05",
        event: "Winner Confirmation + Prepare Award Stage / ဆုရရှိသူများအတည်ပြုခြင်းနှင့် ဆုချီးမြှင့်ပွဲ စင်ပြင်ဆင်ခြင်း",
        category: "Winner announcement after Open event; stage and podium setup",
      ...
      },
      {
        ...
        category: "Winners, podium presentation, sponsor/official presentation, and exhibitor appreciation",
        venue: "MCF compound · Thuwunna",
        type: "Ceremony",
...
const SPECTATOR_NOTES_MM = [
  ...
  "၄၅ မိနစ်ကြာ Open Criterium ပြီးနောက် ဆုရရှိသူများကို အတည်ပြု/ကြေညာပြီး၊ စင်မြင့်ပြင်ဆင်မှုများပြီးနောက် ဆုချီးမြှင့်ပွဲ စတင်ပါမည်။",
  "ပရိသတ်များသည် marshal များ၊ ရဲတပ်ဖွဲ့နှင့် MCF တာဝန်ရှိသူများ၏ ညွှန်ကြားချက်များကို လိုက်နာရမည်။",
];
